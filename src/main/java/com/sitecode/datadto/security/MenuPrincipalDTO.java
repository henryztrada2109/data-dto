...
public class MenuPrincipalDTO extends ErrorDTO implements Serializable{
    ...
    public MenuPrincipalDTO() {
    }

    public MenuPrincipalDTO(Integer codigo, String descripcion) {
        super(codigo, descripcion);
    }

    public MenuPrincipalDTO(Integer idMenuPrincipal, Integer orden, String descripcion, Integer idOpciones,
                            Integer idIcono, Integer idTipoMenu, Integer ejecuta) {
    ...
    public boolean equals(Object o) {
        ...
        MenuPrincipalDTO that = (MenuPrincipalDTO) o;
