...
public class ValidacionesInscripcionesDTO extends ErrorDTO implements Serializable{
    ...
    public ValidacionesInscripcionesDTO() {
    }

    public ValidacionesInscripcionesDTO(Integer code, String description) {
        super(code, description);
    }

    public ValidacionesInscripcionesDTO(Integer idRole, Boolean periodo, Boolean nombres, Boolean apellidos,
    ...
    public boolean equals(Object o) {
        ...
        ValidacionesInscripcionesDTO that = (ValidacionesInscripcionesDTO) o;
    ...
    @Override
    public int hashCode() {
        return Objects.hash(super.hashCode(), idRole, periodo, nombres, apellidos, genero, fechaNacimiento,
                telefonoCasa, telefonoCelular, correoElectronico, profesion, estadoCivil, ocupacion, tipoIdentificacion,
                identificacion, pais, departamento, municipio, direccion);
    }

    @Override
    public String toString() {
        return "ValidacionesInscripcionesDTO{" +
                "idRole=" + idRole +
                ", periodo=" + periodo +
                ", nombres=" + nombres +
                ", apellidos=" + apellidos +
